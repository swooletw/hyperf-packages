...
class FormBuilder
{
     ...
     */
    public function suggest(string $label, array|Closure|Collection $options, string $placeholder = '', string $default = '', int $scroll = 5, bool|string $required = false, mixed $validate = null, string $hint = '', ?string $name = null, ?Closure $transform = null): self
    {
     ...
     */
    public function progress(string $label, int|iterable $steps, ?Closure $callback = null, string $hint = '', ?string $name = null): self
    {
