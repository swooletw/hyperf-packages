...
class DatabaseSQLiteSchemaGrammarTest extends TestCase
{
    ...
    //     $manager = $resolver->connection()->getDoctrineSchemaManager();
    ...
    public function testCreateTableWithVirtualAsColumn()
    {
        ...
        $this->assertCount(1, $statements);
        $this->assertSame('create table "users" ("my_json_column" varchar not null, "my_other_column" varchar as (json_extract("my_json_column", \'$."some_attribute"\')) not null)', $statements[0]);
        ...
        $this->assertCount(1, $statements);
        $this->assertSame('create table "users" ("my_json_column" varchar not null, "my_other_column" varchar as (json_extract("my_json_column", \'$."some_attribute"."nested"\')) not null)', $statements[0]);
    }
    ...
    public function testCreateTableWithVirtualAsColumnWhenJsonColumnHasArrayKey()
    {
        ...
        $this->assertCount(1, $statements);
        $this->assertSame("create table \"users\" (\"my_json_column\" varchar as (json_extract(\"my_json_column\", '$.\"foo\"[0][1]')) not null)", $statements[0]);
    }
    ...
    public function testCreateTableWithStoredAsColumn()
    {
        ...
        $this->assertCount(1, $statements);
        $this->assertSame('create table "users" ("my_json_column" varchar not null, "my_other_column" varchar as (json_extract("my_json_column", \'$."some_attribute"\')) stored not null)', $statements[0]);
        ...
        $this->assertCount(1, $statements);
        $this->assertSame('create table "users" ("my_json_column" varchar not null, "my_other_column" varchar as (json_extract("my_json_column", \'$."some_attribute"."nested"\')) stored not null)', $statements[0]);
    }
